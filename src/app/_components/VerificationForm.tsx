        ...
        <form><center>
            <div>
                ...
                <div className="relative z-20 rounded-[20px]  mx-[15.5rem]  bg-white dark:bg-dark-2">
                    ...
                    >
                        <option value="Kannur" className="text-dark-5 dark:text-dark-6">
                            kannur
                        </option>
                        <option value="Calicut" className="text-dark-5 dark:text-dark-6">
                        Calicut
                        </option>
                        <option value="MG" className="text-dark-5 dark:text-dark-6">
                        MG
                        </option>
