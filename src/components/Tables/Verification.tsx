...
type Props = {
  listOfVerification: any;
};

const VerificationTable = ({ listOfVerification: listOfVerification }: Props) => {
  console.log(listOfVerification)
              ...
              <table className="w-full ">
                <thead>
                  <tr className="bg-[#F7F9FC] text-left dark:bg-dark-2">
                    ...
                    <th className="min-w-[150px] px-4 py-4 font-medium text-dark dark:text-white"></th>
                ...
                <tbody>
                  {listOfVerification?.map((packageItem: any, index:number) => (
                    <tr key={index}>
                      <td
